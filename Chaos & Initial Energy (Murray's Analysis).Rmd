...
3.  Pendulum arm was brought to the desired initial angle, as measure using protractor, and held until all nodes were motionless.
...
Our data collection process produced approximately 10Gb of recordings. In order to extract the node position data from these
